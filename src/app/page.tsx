...
export default function Home() {
  ...
  return (
    ...
    >
      <header className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6 flex justify-between items-center relative z-20">
        <motion.div
        ...
        <Animatedsection>
          <div className="text-center py-14 md:py-20">
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl lg:text-2xl text-gray-400 mb-10 max-w-3xl mx-auto"
            >
            ...
            <motion.button
              ...
              className="bg-blue-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-md text-base md:text-xl hover:bg-blue-700 transition-colors flex items-center mx-auto"
            >
...
className="bg-gray-800 p-4 md:p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300 relative overflow-hidden group"
>
                <img
              ...
              <div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="text-4xl md:text-5xl font-bold text-blue-500">500+</div>
        ...
        <Animatedsection>
          <div className="bg-blue-600 rounded-2xl px-6 md:px-12 py-10 md:py-12 text-center relative overflow-hidden group">
            <motion.div
            ...
            <motion.button
              className="bg-white text-blue-600 px-6 md:px-8 py-3 md:py-4 rounded-md text-base md:text-xl font-bold hover:bg-gray-100 transition-colors relative z-10"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
